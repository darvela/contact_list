  ...
  Widget build(BuildContext context) {
    final list = ListView(
      children: <Widget>[
        ...
        Contact("Diego", "3 years","assets/img/4cristina.jpg",0xFFff0000),
        Contact("Astrid", "4 years","assets/img/5liliana.jpg",0xFFff0000),
        Contact("Critsina", "16 years","assets/img/6alberto.jpg",0xFFff0000),
        Contact("Liliana", "9 years","assets/img/7rocio.jpg",0xFFff0000),
        Contact("Alberto", "2 years","assets/img/8constanza.jpg",0xFFff0000),
        Contact("Constanza", "2 years","assets/img/9pedro.jpg",0xFFff0000),
